 ...
 * @Observation Brazillian PIS or NIS number (Número de Identificação Social Pis ou Pasep) is the equivalent of a
 ...
 *	<input class="productinfo" name="Observation">
 *
 *	...will validate unless at least one of them is filled.
 *
 * partnumber:	{require_from_group: [1,".productinfo"]},
 * Observation: {require_from_group: [1,".productinfo"]}
 *
 ...
 * Observation: {skip_or_fill_minimum: [2,".productinfo"]},
